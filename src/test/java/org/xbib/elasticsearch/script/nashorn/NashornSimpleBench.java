 ...
 *
 */
public class NashornSimpleBench {

    static final long ITER = 100000;
    public static void main(String[] args) {
    	ScriptEngineService se = new NashornScriptEngineService(ImmutableSettings.Builder.EMPTY_SETTINGS);
    	System.out.println("Bench Nashorn... " + ITER + " iterations.");
        bench(se);
    }
